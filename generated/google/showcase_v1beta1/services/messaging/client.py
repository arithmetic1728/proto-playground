...
class MessagingClient(metaclass=MessagingClientMeta):
    ...
    def send_blurbs(self,
            requests: Iterator[messaging.CreateBlurbRequest] = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            requests (Iterator[`~.messaging.CreateBlurbRequest`]):
    ...
    def connect(self,
            requests: Iterator[messaging.ConnectRequest] = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            requests (Iterator[`~.messaging.ConnectRequest`]):
                The request object iterator. The request message for the
